...
export default function Home() {
  ...
  return (
    <>
      ...
      />
      <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white bg-white">
          ...
          <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            ...
            <ol>
              <li>
                ...
                able to see how users will interact with your design once it’s
                live;
              </li>
              <li>
            ...
            <section className="not-format">
              ...
              <form className="mb-6">
                <div className="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700"></div>
                <button
                  type="submit"
